            ...
            <div className='flex h-full flex-auto flex-col space-y-12 p-6'>
              <div className='flex flex-col items-center gap-3'>
                ...
                <div className='flex gap-2'>
                  <button className='font-inherit transition-background relative inline-flex h-10 flex-shrink-0 cursor-pointer items-center overflow-hidden rounded-md border-none bg-neutral-900 px-8 text-sm font-semibold text-white no-underline transition-shadow duration-200 hover:bg-neutral-800 hover:shadow-md'>
                    Resources
                  </button>
                  <a
                    href='#'
